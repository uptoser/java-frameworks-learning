...
@ComponentScan(basePackages = { "com.uptoser.ssm.spring.c2.di.annotation" }, excludeFilters = {
		@Filter(type = FilterType.REGEX, pattern = "com.uptoser.ssm.spring.c2.di.annotation.config.ApplicationConfig") })
